...
class _FavoritesState extends State<Favorites> {
  int select = 0, foodList = 0, recipeList = 0;
  List<IconButton> nav = [];
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar:
            (select == 0 || recipeList == 0) ? NavBar(selected: 4) : null,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          NavButton(Icons.home, Colors.grey[700], Colors.white, 1),
          NavButton(Icons.search, Colors.grey[700], Colors.white, 2),
          NavButton(Icons.photo_camera, Colors.white, Green, 3),
          NavButton(Icons.favorite_rounded, Coral, Colors.white, 4),
          NavButton(Icons.person_outline, Colors.grey[700], Colors.white, 5),
        ],
      ),
    );
  }

  Container NavButton(IconData icon, Color color, Color bg, int i) {
    return Container(
      height: 85,
      child: TextButton(
        onPressed: () {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: NavBar(selected: 5),
        body: Center(
          child: Container(
            margin: EdgeInsets.all(20),
